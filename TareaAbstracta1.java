...
class Resistencia extends Sensor{
    ...
    public void MAP(){
        ...
        System.out.println("Dentro del Metodo MAP de la clase Resistencia");
...
class Potencia extends Sensor{
    ...
    public void MAF(){
        ...
        System.out.println("Dentro del Metodo MAF de la clase Potencia");
...
public class TareaAbstracta1 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\t****UNIVERSIDAD DE LAS FUERZAS ARMADAS E.S.P.E.**** ");
        System.out.println("\t\t*******SEDE LATACUNGA*******\n");
        System.out.println("Docente: Ing. Luis Alberto Guerra Cruz.");
        System.out.println("Integrantes:Dario Chisaguano y William Taco");
